...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Add New List Price (Contract) / Installment Price No Down Payment</h6>
                    <form action="{{ route('store.installment.pricelist.nodown') }}" method="POST">
                        @csrf
                        <input type="hidden" name="id" id="id" value="{{ $product->id }}"></input>
                        <div class="row">
                        <div class="col-sm-4">
                                <div class="mb-3">
                                    <label for="contract_price" class="form-label">Principal</label>
                                    <input type="number" name="contract_price" id="contract_price" value="{{ $product->listPrice->contract_price }}" class="form-control @error('contract_price') is-invalid @enderror" placeholder="₱00.00" readonly>
