...
<div class="page-content">
    <div class="row">
            ...
            <div class="col-sm-4">
                <div class="mb-3">
                    <select class="form-select mb-3" name="installment" id="installmentSelect">
                        <option value="with_down_payment">Installment With Down Payment</option>
                        <option value="no_down_payment" selected>Installment No Down Payment</option>
                    </select>
                </div>
            </div><!-- Col -->
            <div class="col-sm-4">
        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">List Price (Contract) / Installment Price No Down Payment</h6>
                    <a href="{{ route('add.installment.pricelist.nodown', ['id' => $product->id]) }}" class="btn btn-dark btn-xs" style="margin-right: 3px; margin-bottom:15px;">New</a>
                    <a href="{{ route('delete.installment.pricelist.nodown', ['id' => $product->id]) }}" id="delete-installment" class="btn btn-dark btn-xs" style="margin-right: 3px; margin-bottom:15px;">Remove All</a>
