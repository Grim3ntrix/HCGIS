                    ...
                    <h4 class="card-title"><span style="padding-right:8px;"><i data-bs-toggle="tooltip" data-bs-placement="right" title="Make sure Rates is not Empty to Generate and Save PLP" data-feather="help-circle" class=""></i></span>Product List Price</h4>
                        <form action="{{ route('manager.store.list.price') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        <label for="list_price" class="form-label">Price<span style="font-size:12px; color: #0DCAF0;"> (Contract)</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="wdpni_term_1" id="wdpni_term_1" value="{{ optional($termNoInterestPurchaseThatHasBeenSet)->term_in_months }}" data-term="{{ optional($termNoInterestPurchaseThatHasBeenSet)->term_in_months }}" class="form-control @error('wdpni_term_1') is-invalid @enderror" placeholder="Term" readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="ndpni_term_1" id="ndpni_term_1" value="{{ optional($termNoInterestPurchaseThatHasBeenSet)->term_in_months }}" data-term="{{ optional($termNoInterestPurchaseThatHasBeenSet)->term_in_months }}"class="form-control @error('ndpni_term_1') is-invalid @enderror" placeholder="Term" readonly>
