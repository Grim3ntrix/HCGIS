...
<head>
  ...
  <!-- End fonts -->
	...
	<!-- inject:css -->
	<link rel="stylesheet" href="{{asset('../assets/fonts/feather-fonts/css/iconfont.css')}}">
	<link rel="stylesheet" href="{{asset('../assets/vendors/flag-icons-css/css/flag-icon.min.css')}}">
	<!-- endinject -->
