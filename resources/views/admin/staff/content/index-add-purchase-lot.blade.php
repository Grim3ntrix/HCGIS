										...
										<div class="row">
											...
											<div class="col-sm-2">
												<div class="mb-3">
													...
													<input type="text" name="middle_initial" id="middle_initial" class="form-control" placeholder="Enter M.I">
												</div>
											</div><!-- Col -->
											<div class="col-sm-2">
												<div class="mb-3">
										...
										<div class="row">
											<div class="col-sm-8">
												<div class="mb-3">
													...
													<input type="text" name="current_address" id="current_address" class="form-control" placeholder="House No. / Street / Barangay / District / Municipality / Province">
												</div>
											</div><!-- Col -->										
											<div class="col-sm-4">
												<div class="mb-3">
										...
										<div class="row">
											<div class="col-sm-4">
												<div class="mb-3">
													...
													<input type="text" name="marital_status" id="marital_status" class="form-control" placeholder="Single / Married">
												</div>
											</div><!-- Col -->										
											<div class="col-sm-8">
												<div class="mb-3">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="mb-3">
													...
													<input type="text" name="sales_counselor" id="sales_counselor" class="form-control" placeholder="Enter sales counselor">
												</div>
											</div><!-- Col -->
											<div class="col-sm-6">
												<div class="mb-3">
													<label class="form-label">Agency Manager</label>
													<input type="text" name="agency_manager" id="agency_manager" class="form-control" placeholder="Enter agency manager">
												</div>
											</div><!-- Col -->																	
										</div><!-- Row -->
